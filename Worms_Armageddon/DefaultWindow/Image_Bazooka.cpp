...
void CImage_Bazooka::Initialize(CObj * _pObj)
{
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Data/Image/Weapon/Bazooka.bmp", L"Bazooka");
	m_hCurrDC = CBmpMgr::Get_Instance()->Find_Image(L"Bazooka");
...
void CImage_Bazooka::Update(void)
{
}

void CImage_Bazooka::LateUpdate(void)
{
	Set_Angle();
...
void CImage_Bazooka::Render(HDC _hDC)
{
...
void CImage_Bazooka::Set_Size(void)
{
	m_fCX = m_pOwner->Get_Pos().fCX;
	m_fCY = m_pOwner->Get_Pos().fCY;
}

void CImage_Bazooka::Reset(void)
{
}

void CImage_Bazooka::Set_Angle(void)
{
