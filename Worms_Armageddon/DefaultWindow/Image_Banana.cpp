...
void CImage_Banana::Initialize(CObj * _pObj)
{
	CBmpMgr::Get_Instance()->Insert_Bmp(L"../Data/Image/Weapon/Banana.bmp", L"Banana");
	m_hCurrDC = CBmpMgr::Get_Instance()->Find_Image(L"Banana");
...
void CImage_Banana::Update(void)
{
	
}

void CImage_Banana::LateUpdate(void)
{
	Set_Angle();
...
void CImage_Banana::Render(HDC _hDC)
{
...
void CImage_Banana::Set_Size(void)
{
	m_fCX = m_pOwner->Get_Pos().fCX;
	m_fCY = m_pOwner->Get_Pos().fCY;
}

void CImage_Banana::Reset(void)
{
}

void CImage_Banana::Set_Angle(void)
{
